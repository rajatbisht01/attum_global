  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      content: "contact@attum.one",
      link: "mailto:contact@attum.one",
    },
    {
      icon: Phone,
      title: "Phone",
      content: "+971-524882602",
      link: "tel:+971524882602",
    },
    {
      icon: MapPin,
      title: "Address",
      content: "Dubai (UAE), Noida (India), Bangalore (India), Belgium",
      link: "#",
    },
  ];

  return (
    <section id="contact" className="pb-12 w-full pl-2 overflow-hidden relative">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <AnimatedText delay={0.4}>
            <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-gray-700">
              ...
              expertise can advance your goals.
            </p>
          </AnimatedText>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <ScrollReveal direction="left" delay={0.6}>
            <Card className="p-8 bg-glass border-brand shadow-xl rounded-2xl hover:shadow-2xl transition-shadow duration-300">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <motion.button
                    type="submit"
                    disabled={loading}
                    className={`w-full bg-brand text-black font-semibold rounded-lg shadow-md flex items-center justify-center px-6 py-3 text-lg transition-all duration-200 ${
                  ...
                  >
                    <Send className="w-5 h-5 mr-2 font-semibold" />
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-8">
                  We're here to help you. Reach out to discuss your specific
                  requirements and explore collaboration opportunities.
                </p>
              </div>
