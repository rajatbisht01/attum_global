...
const AboutSection = () => {
  const values = [
    ...
    },
    {
      ...
      description:
        "Every solution is tailored to our clients unique needs and business objectives.",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Excellence Driven",
      description:
        "We maintain the highest standards of quality in every project and partnership.",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Global Impact",
      description:
        "Our solutions create positive change that extends across industries and borders.",
    },
  ];
          ...
          <div className="mb-12">
            ...
            >
              <p className="text-gray-600 text-lg leading-relaxed max-w-4xl mx-auto mb-12 text-center">
                ...
                enterprises build, secure, and innovate. With over a decade of
                experience in software development, cloud, data, and emerging
                technologies, ATTUM delivers resourcing solutions that drive
                real outcomes and enable sustainable growth.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our services empower businesses to modernize and scale their
                    digital foundations. From full-stack development and cloud
                    engineering to data pipelines and enterprise integrations,
                    ATTUM provides the talent and expertise to deliver agile,
                    reliable, and future-ready systems.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    We ensure your technology works at scale with confidence.
                    ATTUM provides testing, performance engineering, and
                    cybersecurity solutions including SOC resourcing, IAM, and
                    zero-trust frameworks — ensuring compliance, resilience, and
